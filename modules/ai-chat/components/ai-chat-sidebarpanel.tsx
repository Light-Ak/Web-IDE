...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
    ...
    const [model, setModel] = useState<string>("qwen2.5-coder:1.5b");
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content: 
            "I'm having trouble connecting to the local AI. Please ensure [Ollama](https://ollama.com) is installed and the model is running in your terminal:\n\n```bash\nollama run qwen2.5-coder:1.5b\n```",
          timestamp: new Date(),
          id: Date.now().toString(),
        },
      ]);
